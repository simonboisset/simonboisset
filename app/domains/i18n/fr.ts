...
export const fr: Translation = {
  ...
  pricing: {
    ...
    project_rate: {
      ...
      advise_on_scope_definition:
        "Accompagnement sur la définition du périmètre",
  ...
  consent: {
    ...
    bannerTitle: "Mon site utilise des cookies",
    bannerDescription:
      "Nous utilisons des cookies pour vous offrir une meilleure expérience utilisateur et pour analyser le trafic de notre site.",
    bannerThanksForTakingTime:
      "Merci de prendre le temps de donner votre consentement.",
    whatAreYourCookiesUsedFor: "À quoi servent vos cookies?",
    shareDataToGoogle:
    ...
    authoriseGoogleAnalyticsToCollectUserDataToOfferYouPersonalisedAds:
      "Autoriser Google Analytics à collecter des données utilisateur pour vous offrir des publicités personnalisées.",
    authoriseGoogleAnalyticsToCustomiseTheAdsYouSeeOnOurWebsite:
      "Autoriser Google Analytics à personnaliser les publicités que vous voyez sur notre site web.",
    authoriseGoogleAnalyticsToMeasureYourUseOfOurWebsiteToImproveOurServices:
      "Autoriser Google Analytics à mesurer votre utilisation de notre site web pour améliorer nos services.",

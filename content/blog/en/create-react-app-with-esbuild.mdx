---
title: Create a react app with esbuild
description: [Esbuild](https://esbuild.github.io/) is a new javascript bundler. It's written with Go and is extremely fast. Let's go to use it to create react with hot reload app from scratch without webpack

---
title: Publier une librairie avec plusieurs packages à l'aide de Turborepo
description: Maintenant que nous savons publier un package sur npm, nous allons voir comment gérer une librairie qui comporte plusieurs packages.

---
title: Partager son code entre des projets React et React Native sur un monorepo
description: Comment lier un package npm `core` entre un projet web React par exemple et un projet `mobile` React Native ?
